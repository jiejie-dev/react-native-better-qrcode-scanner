...
export default class QRScannerRectView extends React.Component<Props, State> {
  ...
  //测量整个扫描组件的大小
  measureTotalSize(e: LayoutChangeEvent) {
    let totalSize = e.nativeEvent.layout
    this.setState({
  ...
  //测量扫描框的位置
  measureRectPosition(e: LayoutChangeEvent) {
    let rectSize = e.nativeEvent.layout
    this.setState({
