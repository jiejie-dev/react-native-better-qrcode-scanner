        ...
        renderTopBarView={() => {
          return (
            <View style={Styles.view_title_container}>
              ...
              />
              <Text style={{ color: Colors.blue_4187E8, fontSize: 18 }}>扫码</Text>
              <Text style={{ color: 'white', fontSize: 18 }}>扫物</Text>
              <Text style={{ color: 'white', fontSize: 18, marginRight: 80 }}>扫题</Text>
            </View>
          )
        }}
        renderBottomMenuView={() => {
          return (
            <View style={Styles.view_bottom_menu_container}>
              <ImageButton style={Styles.image_qqbrowser_light} source={Images.ic_qrcode_light} />
