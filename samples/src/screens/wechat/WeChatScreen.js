          ...
          return (
            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
              <View style={Styles.view_bottom_menu_item}>
                <ImageButton style={Styles.image_bottom_menu} source={Images.ic_wechat_scan_hl} />
                <Text style={Styles.text_bottom_menu_item}>扫码</Text>
              </View>

              <View style={Styles.view_bottom_menu_item}>
                <ImageButton style={Styles.image_bottom_menu} source={Images.ic_wechat_scan_book} />
                <Text style={Styles.text_bottom_menu_item}>封面</Text>
              </View>
              ...
              <View style={Styles.view_bottom_menu_item}>
                ...
                />
                <Text style={Styles.text_bottom_menu_item}>街景</Text>
              </View>

              <View style={Styles.view_bottom_menu_item}>
                <ImageButton style={Styles.image_bottom_menu} source={Images.ic_wechat_scan_word} />
                <Text style={Styles.text_bottom_menu_item}>翻译</Text>
              </View>
            </View>
          )
        }}
