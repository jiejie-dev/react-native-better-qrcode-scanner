      ...
      <View style={styles.view_container}>
        <View style={styles.view_avatar_name_container}>
          <View style={styles.view_avatar_container}>
            <Image style={styles.image_avatar} source={Images.ic_avatar} />
          </View>
          <Text style={{ fontSize: 18, color: 'black' }}>Marno</Text>
        </View>

        <TouchableWithoutFeedback onPress={this._navigateToWeChat.bind(this)}>
          <View>
            <Text style={[styles.text_item, { backgroundColor: Colors.green_00C853 }]}>WeChat</Text>
          </View>
        </TouchableWithoutFeedback>

        <TouchableWithoutFeedback onPress={this._navigateToTwitter.bind(this)}>
          <View>
            <Text style={[styles.text_item, { backgroundColor: Colors.red_E53935 }]}>Twitter</Text>
          </View>
        </TouchableWithoutFeedback>

        <TouchableWithoutFeedback onPress={this._navigateToQQBrowser.bind(this)}>
          <View>
            <Text style={[styles.text_item, { backgroundColor: Colors.blue_009688 }]}>
              QQBrowser
            </Text>
          </View>
        </TouchableWithoutFeedback>
        ...
        <TouchableWithoutFeedback onPress={this._navigateToOFO.bind(this)}>
          <View>
            <Text style={[styles.text_item, { backgroundColor: Colors.yellow_ffc962 }]}>OFO</Text>
          </View>
        </TouchableWithoutFeedback>

        <TouchableWithoutFeedback onPress={this._navigatorToDefault.bind(this)}>
          <View>
            <Text style={[styles.text_item, { backgroundColor: Colors.blue_00B0FF }]}>Default</Text>
          </View>
        </TouchableWithoutFeedback>
